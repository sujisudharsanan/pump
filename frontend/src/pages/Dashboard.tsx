  ...
  const fetchDashboardData = async () => {
    try {
      ...
      setStats({
        totalPumps: 8,
        activePumps: 6,
        todaysSales: 25430.50,
        totalTransactions: 142,
      });

      setPumps([
        { id: 1, status: 'active', fuelLevel: 85, currentTransaction: 'TXN001' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <span className="ml-4 px-3 py-1 bg-yellow-400 text-black text-sm 
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="w-12 h-12 bg-yellow-100 rounded-lg flex items-center 
                            justify-center">
